 ...
 */
class Category extends \Library\MainBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Library\\MainBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Library\\MainBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Library\\MainBundle\\Entity\\Category' . "\0" . 'books');
        }

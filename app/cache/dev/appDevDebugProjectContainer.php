...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'library.book_agent' => 'getLibrary_BookAgentService',
            'library.findbook_agent' => 'getLibrary_FindbookAgentService',
            'library.librarycard_agent' => 'getLibrary_LibrarycardAgentService',
            ...
            'sonata.admin.slider' => 'getSonata_Admin_SliderService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_613124056e64afc9263a1512662a9123a7a031e1fc18c23f5227f4984bf234c4');
    ...
    /**
     * Gets the 'library.book_agent' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Library\MainBundle\Agent\BookAgent A Library\MainBundle\Agent\BookAgent instance.
     */
    protected function getLibrary_BookAgentService()
    {
        return $this->services['library.book_agent'] = new \Library\MainBundle\Agent\BookAgent($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'library.findbook_agent' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Library\MainBundle\Agent\FindBookAgent A Library\MainBundle\Agent\FindBookAgent instance.
     */
    protected function getLibrary_FindbookAgentService()
    {
        return $this->services['library.findbook_agent'] = new \Library\MainBundle\Agent\FindBookAgent($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'library.librarycard_agent' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Library\MainBundle\Agent\LibraryCardAgent A Library\MainBundle\Agent\LibraryCardAgent instance.
     */
    protected function getLibrary_LibrarycardAgentService()
    {
        return $this->services['library.librarycard_agent'] = new \Library\MainBundle\Agent\LibraryCardAgent($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.slider', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Biblioteka' => array('label' => 'Biblioteka', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.slider')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('Library\\MainBundle\\Entity\\Book' => array(0 => 'sonata.admin.slider'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.slider', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.slider' service.
     *
     * @return \Library\MainBundle\Admin\BookAdmin A Library\MainBundle\Admin\BookAdmin instance.
     */
    protected function getSonata_Admin_SliderService()
    {
        $instance = new \Library\MainBundle\Admin\BookAdmin('sonata.admin.slider', 'Library\\MainBundle\\Entity\\Book', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('LibraryMainBundle');

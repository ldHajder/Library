...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'library_user.registration.form.type' => 'getLibraryUser_Registration_Form_TypeService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/XAMPP/htdocs/Library/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('D:/XAMPP/htdocs/Library/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/XAMPP/htdocs/Library/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/XAMPP/htdocs/Library/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'library', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'\\src\\Library\\MainBundle\\Resources\\config\\doctrine') => 'Library\\MainBundle\\Entity', (dirname(dirname(dirname(__DIR__))).'\\src\\Library\\UserBundle\\Resources\\config\\doctrine') => 'Library\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($a, 'FOS\\UserBundle\\Entity');
        $c->addDriver($b, 'Library\\MainBundle\\Entity');
        $c->addDriver($b, 'Library\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'LibraryMainBundle' => 'Library\\MainBundle\\Entity', 'LibraryUserBundle' => 'Library\\UserBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir('D:/XAMPP/htdocs/Library/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_02c11a07213fb40d68e29f546475d5d9fa747d0cb0b7e0b058c1c6c656b3132d');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/XAMPP/htdocs/Library/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Library\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'library_user_registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Library\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Library\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'ivory_lucene_search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ivory\LuceneSearchBundle\Model\LuceneManager A Ivory\LuceneSearchBundle\Model\LuceneManager instance.
     */
    protected function getIvoryLuceneSearchService()
    {
        return $this->services['ivory_lucene_search'] = new \Ivory\LuceneSearchBundle\Model\LuceneManager();
    }
    ...
    /**
     * Gets the 'library_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Library\UserBundle\Form\Type\RegistrationFormType A Library\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getLibraryUser_Registration_Form_TypeService()
    {
        return $this->services['library_user.registration.form.type'] = new \Library\UserBundle\Form\Type\RegistrationFormType('Library\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/XAMPP/htdocs/Library/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/XAMPP/htdocs/Library/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/XAMPP/htdocs/Library/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/XAMPP/htdocs/Library/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/XAMPP/htdocs/Library/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/XAMPP/htdocs/Library/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/XAMPP/htdocs/Library/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/XAMPP/htdocs/Library/app', 'UTF-8');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Library\\MainBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Library\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/XAMPP/htdocs/Library/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/XAMPP/htdocs/Library/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Library\\MainBundle/Resources/views'), 'LibraryMain');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Library\\UserBundle/Resources/views'), 'LibraryUser');
        ...
        $instance->addPath('D:/XAMPP/htdocs/Library/app/Resources/views');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Library\\MainBundle\\Resources\\config\\validation.yml')));
        ...
        $instance->addXmlMapping((dirname(dirname(dirname(__DIR__))).'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\DependencyInjection\\Compiler/../../Resources/config/validation/orm.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/XAMPP/htdocs/Library/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/XAMPP/htdocs/Library/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/XAMPP/htdocs/Library/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/XAMPP/htdocs/Library/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'D:/XAMPP/htdocs/Library/app/cache/dev',
            'kernel.logs_dir' => 'D:/XAMPP/htdocs/Library/app/logs',
            'kernel.bundles' => array(
                ...
                'LibraryUserBundle' => 'Library\\UserBundle\\LibraryUserBundle',
            ...
            'debug.container.dump' => 'D:/XAMPP/htdocs/Library/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/XAMPP/htdocs/Library/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/XAMPP/htdocs/Library/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/XAMPP/htdocs/Library/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/XAMPP/htdocs/Library/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/XAMPP/htdocs/Library/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/XAMPP/htdocs/Library/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/XAMPP/htdocs/Library/app/../web',
            'assetic.write_to' => 'D:/XAMPP/htdocs/Library/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/XAMPP/htdocs/Library/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Library\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'library_user_registration',

...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/library/main/book')) {
                // admin_library_main_book_list
                if ($pathinfo === '/admin/library/main/book/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_list',  '_route' => 'admin_library_main_book_list',);
                }

                // admin_library_main_book_create
                if ($pathinfo === '/admin/library/main/book/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_create',  '_route' => 'admin_library_main_book_create',);
                }

                // admin_library_main_book_batch
                if ($pathinfo === '/admin/library/main/book/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_batch',  '_route' => 'admin_library_main_book_batch',);
                }

                // admin_library_main_book_edit
                if (preg_match('#^/admin/library/main/book/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_library_main_book_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_edit',));
                }

                // admin_library_main_book_delete
                if (preg_match('#^/admin/library/main/book/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_library_main_book_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_delete',));
                }

                // admin_library_main_book_show
                if (preg_match('#^/admin/library/main/book/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_library_main_book_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_show',));
                }

                // admin_library_main_book_export
                if ($pathinfo === '/admin/library/main/book/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.slider',  '_sonata_name' => 'admin_library_main_book_export',  '_route' => 'admin_library_main_book_export',);
                }
